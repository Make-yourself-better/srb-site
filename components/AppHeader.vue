    ...
    <div class="header-top min-width">
      <div class="container fn-clear">
        ...
        <ul v-if="!userInfo" class="fn-right header-top-ul">
          ...
          <li>
            <div class="">
              <NuxtLink to="/register" :class="{ 'c-orange': $route.fullPath === '/register' }">
                免费注册
              </NuxtLink>
            </div>
          </li>
          <li>
            <div class="">
              <NuxtLink to="/login" :class="{ 'c-orange': $route.fullPath === '/login' }">
                登录
              </NuxtLink>
            </div>
          </li>
        ...
        <ul v-if="userInfo" class="fn-right header-top-ul">
          ...
          <li>
            <div class="">
              <a href="javascript:void(0)" class="js-login" @click="logout()" title="退出">
                退出
              </a>
            </div>
          </li>
...
export default {
  ...
  methods: {
    ...
    showInfo() {
      ...
      //先在服务器端校验token
      this.$axios({
        url: '/admin/core/userinfo/checkToken',
        method: 'get',
        headers: {
