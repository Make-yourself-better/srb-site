<template>
  <div class="personal-main">
    <div class="personal-deposit">
      ...
      <div class="deposit-form" style="margin-top:0px;border-top:0px none;width:auto;height:240px;">
        <h6>填写提现金额</h6>
        <ul>
          <li>
            <span class="deposit-formleft">提现金额</span>
            <span class="deposit-formright">
              <input v-model="fetchAmt" type="text" class="deposite-txt" maxlength="10" />
              元
            </span>
          </li>
          <li>
          ...
          <li>
            <input type="submit" value="马上提现" class="btn-depositok" onclick="return checkActualMoney()"
